...
<?php include('style-font_854X720.php'); ?>
...
<body style="background-color:#FFFFFF; ">
    ...
    <div class="object-wrapper">
        <div style="width:854px;height:720px; background-color: #DDE3EF;" align="center">
            <?php include('txt-header.php'); ?>
            <div id="backgroundHeader" style="width:802px;height:292px; margin-left: 7px; margin-right:7px;margin-top:20px;border-radius: 20px;box-shadow:1px 6px 14px #959595;">
            ...
            <div id="backgroundFooter" style="width:802px;height:292px; margin-left: 7px; margin-right:7px;margin-top:15px;border-radius: 20px;box-shadow:1px 6px 14px #959595;" align="right">
                <table style="position: absolute;" width="804" border="0">
                    <tr>
                        <td width="20%">
                ...
                <div style="width:640px;height:292px;background-color:#FFFFFF;margin-top:15px;border-radius: 20px;">
